...
public class Colleague1Link extends ScreenShot{
...
public void run1(){
		...
		ScreenShot.screenshotQA(driver, "1. Login","Colleague1");
		...
		if(driver.findElement(By.id("cmdOK")).isDisplayed()){
			...
			Thread.sleep(4000);
			ScreenShot.screenshotQA(driver, "2. DataProtection","Colleague1");
		...
		ScreenShot.screenshotQA(driver, "3. Assessment Begin","Colleague1");
		driver.findElement(By.xpath("html/body/div[2]/div/div[3]/table/tbody/tr[1]/td[1]/a")).click();
		ScreenShot.screenshotQA(driver, "4. Intro_Page","Colleague1");
		...
		Thread.sleep(1000);
			...
			Thread.sleep(2000);		
		ScreenShot.screenshotQA(driver, "5. Question_"+SCR,"Colleague1");
		SCR=SCR+1;
		driver.findElement(By.id("cmdNext")).click();	
		Thread.sleep(4000);
		}
...
if(A1.isDisplayed()){
	...
	driver.close();
		...
		if(C==true){
			if(SCR2==1 || SCR2%4==0){	
				ScreenShot.screenshotQA(driver, "6. Competency description_"+SCR2,"Colleague1");	
				}
				SCR2=SCR2+1;		
		driver.findElement(By.xpath(A)).click();
		Thread.sleep(2000);
		...
		ScreenShot.screenshotQA(driver, "6. Last Competency description_","Colleague1");	
		driver.findElement(By.id("cmdNext")).click();	
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
